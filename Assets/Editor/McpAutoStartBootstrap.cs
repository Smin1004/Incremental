...
namespace Incremental.EditorTools
{
    ...
    {
        private const string BootstrappedKey = "MCPForUnity.Incremental.AutoStartBootstrapped";
        private const string ReloadRequestedKey = "MCPForUnity.Incremental.AutoStartReloadRequested";
